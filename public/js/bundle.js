...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"auth/auth.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 5:
          ...
          return _context2.abrupt("return", alert(data.message));
        case 8:
          alert('Login Success');
          window.setTimeout(function () {
            location.assign('/');
...
if (registerForm) {
  registerForm.addEventListener('submit', function (e) {
    ...
    (0, _auth.register)(name, email, password);
  });
}
if (loginForm) {
...
},{"./auth/auth.js":"auth/auth.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11883" + '/');
